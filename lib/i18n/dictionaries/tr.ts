...
const tr: Dictionary = {
  ...
  auth: {
    ...
    phoneHint: "Yalnızca rakam — uluslararası biçimde saklarız.",
    errPhoneLetters: "Telefon numarası harf içeremez.",
    errPhoneCountry: "Bir ülke kodu seçin.",
    errPhoneLength: "Bu ülke {expected} hane bekliyor.",
    errPhoneRequired: "Telefon numaranızı girin.",
    errEmailNonAscii: "Yalnızca Latin harfleri kullanın — e-posta adresinde Arapça karakterlere izin verilmez.",
    errEmailFormat: "Geçerli bir e-posta adresi girin.",
    digitsRange: "{min}-{max}",
    verifySentTitle: "E-postanızı doğrulayın",
    verifySentBody: "{email} adresine bir doğrulama bağlantısı gönderdik. Hesabınızı etkinleştirmek için açın — bağlantı 24 saat geçerlidir.",
    verifyPending: "E-postanız henüz doğrulanmadı. Gönderdiğimiz bağlantı için gelen kutunuza bakın.",
    resend: "Bağlantıyı yeniden gönder",
    resending: "Gönderiliyor…",
    resendDone: "Adres kayıtlı ve doğrulanmamışsa yeni bir bağlantı yolda.",
    resendThrottled: "Az önce bir bağlantı gönderildi. Yenisi için bir dakika bekleyin.",
    verifiedTitle: "E-posta doğrulandı",
    verifiedBody: "Hesabınız etkin. Şimdi giriş yapabilirsiniz.",
    verifyAlready: "Bu adres zaten doğrulanmıştı. Giriş yapabilirsiniz.",
    verifyInvalidTitle: "Bu bağlantı geçersiz",
    verifyInvalidBody: "Bağlantı hatalı veya daha önce kullanılmış. Yenisini isteyin.",
    verifyExpiredTitle: "Bu bağlantının süresi doldu",
    verifyExpiredBody: "Doğrulama bağlantıları 24 saat geçerlidir. Aşağıdan yenisini isteyin.",
    emailNotSent: "Hesabınız oluşturuldu ancak doğrulama e-postası gönderilemedi. Yeniden göndermeyi deneyin.",
    signIn: "Giriş yap",
    signUp: "Hesap oluştur",
    signOut: "Çıkış yap",
    loginTitle: "Tekrar hoş geldiniz",
    loginSubtitle: "Projenizi anlık takip etmek için giriş yapın.",
    registerTitle: "Müşteri hesabınızı oluşturun",
    registerSubtitle: "İlerleme, teslimatlar ve tahmini teslim süresi tek yerde.",
    name: "Ad soyad",
