...
const fr: Dictionary = {
  ...
  auth: {
    ...
    phoneHint: "Chiffres uniquement — enregistré au format international.",
    errPhoneLetters: "Un numéro de téléphone ne peut pas contenir de lettres.",
    errPhoneCountry: "Choisissez un indicatif pays.",
    errPhoneLength: "Ce pays attend {expected} chiffres.",
    errPhoneRequired: "Saisissez votre numéro de téléphone.",
    errEmailNonAscii: "Utilisez uniquement des lettres latines — les caractères arabes ne sont pas autorisés dans une adresse e-mail.",
    errEmailFormat: "Saisissez une adresse e-mail valide.",
    digitsRange: "{min}-{max}",
    verifySentTitle: "Confirmez votre e-mail",
    verifySentBody: "Nous avons envoyé un lien de confirmation à {email}. Ouvrez-le pour activer votre compte — valable 24 heures.",
    verifyPending: "Votre e-mail n'est pas encore confirmé. Consultez votre boîte de réception.",
    resend: "Renvoyer le lien",
    resending: "Envoi…",
    resendDone: "Si l'adresse est enregistrée et non confirmée, un nouveau lien est en route.",
    resendThrottled: "Un lien vient d'être envoyé. Patientez une minute.",
    verifiedTitle: "E-mail confirmé",
    verifiedBody: "Votre compte est actif. Vous pouvez vous connecter.",
    verifyAlready: "Cette adresse était déjà confirmée. Vous pouvez vous connecter.",
    verifyInvalidTitle: "Ce lien n'est pas valide",
    verifyInvalidBody: "Le lien est incorrect ou déjà utilisé. Demandez-en un nouveau.",
    verifyExpiredTitle: "Ce lien a expiré",
    verifyExpiredBody: "Les liens de confirmation durent 24 heures. Demandez-en un nouveau ci-dessous.",
    emailNotSent: "Votre compte a été créé, mais l'e-mail de confirmation n'a pas pu être envoyé. Essayez de le renvoyer.",
    signIn: "Se connecter",
    signUp: "Créer un compte",
    signOut: "Se déconnecter",
    loginTitle: "Bon retour",
    loginSubtitle: "Connectez-vous pour suivre votre projet en temps réel.",
    registerTitle: "Créez votre compte client",
    registerSubtitle: "Avancement, livrables et délai estimé au même endroit.",
    name: "Nom complet",
    ...
    hours: "heures",
    daysLeft: "jours avant l'échéance",
  ...
  emails: {
    verify: {
      ...
      body: "Merci d'avoir créé un compte client AAKWHX. Confirmez cette adresse pour activer votre compte et ouvrir votre tableau de bord projet.",
      cta: "Confirmer mon e-mail",
      expiry: "Ce lien est valable 24 heures et utilisable une seule fois.",
      ignore: "Si vous n'êtes pas à l'origine de ce compte, ignorez ce message.",
    },
  },
};
